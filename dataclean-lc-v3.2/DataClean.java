	...
	Vector<data> codegroup=new Vector<data>();  //存储
	  ...
	  public static void main(String[] args) { 
          try { 
        	  ...
        	  //dc1.volumeDeal();
        	  //dc1.LimitedDeal();
        	  System.out.println("@@@@"+dc1.codegroup.size());
        	  for(int i=0;i<dc1.codegroup.size();i++)
        		  System.out.println(((data)dc1.codegroup.get(i)).code);
        	  dc1.writeData();
	  ...
	  public void readData() throws IOException{
		   BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\double lancer\\Desktop\\data.csv"), "utf-8"));//GBK
	  ...
	  public void codesort() throws IOException{ //将数据按code排序，存入codegroup中
		  ...
		  for(int i=0;i<group.size();i++) {
				for(int j=i+1;j<group.size();j++) {
					if(((data)codegroup.get(n)).code==((data)group.get(j)).code) {
						codegroup.add((data)group.get(j));
						n++;
				...
				for(int k=i+1;k<group.size();k++) {
					...
					System.out.println(((data)codegroup.get(n)).code+"kkk"+((data)group.get(k)).code);
					if(((data)codegroup.get(n)).code!=((data)group.get(k)).code) {
						codegroup.add((data)group.get(k));
						System.out.println("kkk"+k);
						n++;
						System.out.println(n+"nnn");
						System.out.println("ccc"+((data)codegroup.get(n)).code);
						break;
					}
				}
				 if(n==group.size())
...
//			}
	  ...
	  public void ask_bid_Deal() throws IOException{
		  for(int i=0;i<codegroup.size();i++) {
				if(((data)codegroup.get(i)).AskPrice[0]==0&&((data)codegroup.get(i)).BidPrice[0]==0) {
					//*********************************写错误日志
					String temps=((data)codegroup.get(i)).LocalTime+"";
					temps.substring(8);//对数组切片
					long templ=Long.parseLong(temps);
					if(((templ>=145600000||templ<=145800000)/*&&(templ<=145660000||templ>=145700000)*/
							&&(((data)codegroup.get(i)).market=="SZ"))
							||((templ>=145559990||templ<=145759990)/*&&(templ<=145660000||templ>=145700000)*/
									&&(((data)codegroup.get(i)).market=="SH")))// 上海市场的字符？？？、     注释的部分为排除去除不规范的部分
				   writejournal(((data)codegroup.get(i)).market,((data)codegroup.get(i)).code,((data)codegroup.get(i)).Time,"the fourth error");  //*********************************写错误日志
				//	2020 0513 9091204700     14:56:59.990 
			}
		}	
	}
	  ...
	  public void writeData() throws IOException {
			...
			for(int i=0;i<codegroup.size();i++) {
				writererrs.append(((data)codegroup.get(i)).market+",");
				writererrs.append(((data)codegroup.get(i)).code+",");
				writererrs.append(((data)codegroup.get(i)).Time+",");
				writererrs.append(((data)codegroup.get(i)).status+",");
				writererrs.append(((data)codegroup.get(i)).PreClose+",");
				writererrs.append(((data)codegroup.get(i)).Open+",");
				writererrs.append(((data)codegroup.get(i)).High+",");
				writererrs.append(((data)codegroup.get(i)).Low+",");
				writererrs.append(((data)codegroup.get(i)).newPrice+",");
				for(int x=0;x<10;x++)
				writererrs.append(((data)codegroup.get(i)).AskPrice[x]+",");
				for(int y=0;y<10;y++)
				writererrs.append(((data)codegroup.get(i)).AskVolume[y]+",");
				for(int z=0;z<10;z++)
				writererrs.append(((data)codegroup.get(i)).BidPrice[z]+",");
				for(int m=0;m<10;m++)
				writererrs.append(((data)codegroup.get(i)).BidVolume[m]+",");
				writererrs.append(((data)codegroup.get(i)).matchItems+",");
				writererrs.append(((data)codegroup.get(i)).Volume+",");
				writererrs.append(((data)codegroup.get(i)).Turnover+",");
				writererrs.append(((data)codegroup.get(i)).TotalBidVolume+",");
				writererrs.append(((data)codegroup.get(i)).TotalAskVolume+",");
				writererrs.append(((data)codegroup.get(i)).IOPV+",");
				writererrs.append(((data)codegroup.get(i)).HighLimited+",");
				writererrs.append(((data)codegroup.get(i)).LowLimited+",");
				writererrs.append(((data)codegroup.get(i)).afterPrice+",");
				writererrs.append(((data)codegroup.get(i)).afterVolume+",");
				writererrs.append(((data)codegroup.get(i)).afterTurnover+",");
				writererrs.append(((data)codegroup.get(i)).afterMatchItems+",");
				writererrs.append(((data)codegroup.get(i)).LocalTime+",");
				writererrs.append(((data)codegroup.get(i)).weightedAvgAskPx+",");
				writererrs.append(((data)codegroup.get(i)).weightedAvgBidPx+"\n");
