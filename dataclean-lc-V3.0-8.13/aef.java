...
public class aef {
	...
	Vector<data> codegroup=new Vector<data>();
	  ...
	  public void readData() throws IOException{
		 ...
		 /* FileReader f1=new FileReader("C:\\Users\\double lancer\\Desktop\\exame.csv");
          ...
          while((line=reader.readLine())!=null){   // 
              ...
              group.add(new data(item[0],Integer.parseInt(item[1]),Integer.parseInt(item[2]),item[3],Float.parseFloat(item[4]),Float.parseFloat(item[5]),Float.parseFloat(item[6]),Float.parseFloat(item[7]),Float.parseFloat(item[8]),Float.parseFloat(item[9]),Float.parseFloat(item[10]),Float.parseFloat(item[11]),
	  ...
	  public void  writeJournal() throws IOException{   //写日志函数 ，参数Time，code 。。。。。。
